...
layui.use(['table', 'jquery', 'admin','laybind','laydate','ajaxpost'], function() {
    ...
    ajaxpost.ajax("/sys-api/sys/cate/selectById",null, {id:dataId},function (res) {
        if(res.code=="200"){
            editData =res.data
    ...
    var active = {
        submit: function() {
            ...
            //发异步
            ajaxpost.ajax("/sys-api/sys/cate/update",null, {id:data.id,cateName:data.cateName, code:data.code},function (res) {
                if(res.code=="200"){
