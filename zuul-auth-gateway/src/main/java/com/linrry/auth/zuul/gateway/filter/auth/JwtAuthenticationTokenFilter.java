package com.linrry.auth.zuul.gateway.filter.auth;

import com.linrry.auth.zuul.gateway.auth.util.JwtTokenUtil;
import com.linrry.auth.zuul.gateway.auth.util.SecurityExpression;
...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        String username = StringUtils.isNotEmpty(authToken)? getUsername(authToken):"";
