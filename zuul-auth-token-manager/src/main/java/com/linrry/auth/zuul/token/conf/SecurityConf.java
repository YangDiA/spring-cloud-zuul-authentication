package com.linrry.auth.zuul.token.conf;

import com.linrry.auth.zuul.token.filter.JwtAuthenticationTokenFilter;
import com.linrry.auth.zuul.token.mapper.UserRoleMapper;
import com.linrry.auth.zuul.token.response.JwtAuthenticationEntryPoint;
import com.linrry.auth.zuul.token.mapper.RoleMapper;
...
public class SecurityConf extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/unchk/auth/**").permitAll()
